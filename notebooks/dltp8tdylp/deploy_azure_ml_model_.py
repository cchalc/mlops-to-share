...
dbutils.widgets.text(name = "model_name", defaultValue = "wine-model", label = "Model Name")
...
# MAGIC The ACI platform is the recommended environment for staging and developmental model deployments.
