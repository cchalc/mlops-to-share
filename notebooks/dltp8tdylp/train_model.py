...
# MAGIC %sh 
# MAGIC if [ ! -f /dbfs/FileStore/tables/winequality_red.csv ]; then
# MAGIC   mkdir -p /dbfs/FileStore/tables/
# MAGIC   wget -O /dbfs/FileStore/tables/winequality_red.csv https://archive.ics.uci.edu/ml/machine-learning-databases/wine-quality/winequality-red.csv
# MAGIC fi

# COMMAND ----------

wine_data_path = "/FileStore/tables/winequality_red.csv"
...
l1_ratio_1 = 0.25
model_path = 'model'
run_id1 = train_model(data=pdf, model_path=model_path, alpha=alpha_1, l1_ratio=l1_ratio_1)
...
if trigger == "True":
  ...
  personal_access_token = dbutils.secrets.get('akv-secrets','databricks-access-token-ado')
  organization_url = 'https://dev.azure.com/christopherchalcraft'
